...
class MasterPnsNonpnsController extends Controller
{
    ...
    {   
        ...
        if($request->isAjax){
            ...
            return [
                    'title'=> "Data Master Pns Non-pns #".$id,
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Tambah Data Master Pns Non-pns",
                ...
                return [
                    ...
                    'title'=> "Tambah Data Master Pns Non-pns",
                    'content'=>'<span class="text-success">Data Master Pns Non-pns Berhasil ditambahkan</span>',
                    'footer'=> Html::button('Tutup',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Perbarui Data Master Pns Non-pns #".$id,
    ...
    /**
     * Delete an existing TbMasterPnsNonpns model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing TbMasterPnsNonpns model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
