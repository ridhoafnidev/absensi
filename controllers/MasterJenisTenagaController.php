    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new TbMasterJenisTenaga",
                ...
                return [
                    ...
                    'title'=> "Create new TbMasterJenisTenaga",
                    'content'=>'<span class="text-success">Create TbMasterJenisTenaga success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update TbMasterJenisTenaga #".$id,
