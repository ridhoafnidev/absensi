...
class MasterPangkatGolonganController extends Controller
{
    ...
    {   
        ...
        if($request->isAjax){
            ...
            return [
                    'title'=> "Master Pangkat Golongan #".$id,
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Tambah Master Pangkat Golongan",
                ...
                return [
                    ...
                    'title'=> "Create new Master Pangkat Golongan",
                    'content'=>'<span class="text-success">Create Master Pangkat Golongan success</span>',
                    'footer'=> Html::button('Tutup',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update Master Pangkat Golongan #".$id,
    ...
    /**
     * Delete an existing TbMasterPangkatGolongan model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing TbMasterPangkatGolongan model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
