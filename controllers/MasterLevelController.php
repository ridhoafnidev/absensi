...
class MasterLevelController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Tambah Data Master Level",
                ...
                return [
                    ...
                    'title'=> "Tambah Data Master Level",
                    'content'=>'<span class="text-success">Data Master Level Berhasil ditambahkan</span>',
                    'footer'=> Html::button('Tutup',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Perbarui Data Master Level #".$id,
    ...
    /**
     * Delete an existing TbMasterLevel model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing TbMasterLevel model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
