...
$this->title = 'Data Master Status Absensi';
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Tambah Data Master Status Absensi','class'=>'btn btn-default']).
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => 'Data Master Status Absensi',
