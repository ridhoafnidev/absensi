...
class MasterJabatanFungsionalController extends Controller
{
    ...
    {   
        ...
        if($request->isAjax){
            ...
            return [
                    'title'=> "TbMasterJabatanFungsional #".$id,
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new TbMasterJabatanFungsional",
                    'content'=>'<span class="text-success">Create TbMasterJabatanFungsional success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update TbMasterJabatanFungsional #".$id,
